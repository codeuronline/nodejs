...
route.get('/restaurant/:id', (req, res) => {
    ...
    // requete
    let sql_template = "SELECT * FROM ?? WHERE id_restaurant = " + id;
    // formater la requete
...
route.get('/restaurant/:idResto/employe/:idEmploye', (req, res) => {
    ...
    // formater requete
    var replaces = ['employes', 'id_restaurant', 'restaurant_id'];
    sql = mysql.format(sql_template, replaces);
    // executer la requete
    connection.query(sql, function (err, rows) {
        if (err) throw err;
...
route.put('/restaurants/:idResto/employes/:idEmploye', (req, res) => {
    ...
    let sql_update = "UPDATE ?? SET first_name ='" + req.body.first_name +
                                    ...
                                    " WHERE ?? = " + idResto;
                                    " AND ?? = " + idEmploye;
    let replaces = ['employes', 'id_restaurant', 'id_employe'];
    sql = mysql.format(sql_update, replaces);
     // Executer la requête
    connection.query(sql, function(err, row, fields) {
        if (err) throw err;
...
route.delete('/restaurants/:id', (req, res) => {
    ...
    let replaces_employes = ['employes', 'id_restaurant'];
